function setDateCol(collectionDateCols,id){
  ...
  $.each(collectionDateCols,function(i,item){
	  jQuery("#"+item,"#collect_form_tb").datepicker({
		   yearRange:'1960:2020',
		   changeMonth: true,
          changeYear: true,
	   ...
	   jQuery("#"+id+"_"+item,"#jqGrid_collect_tb").datepicker({
		   yearRange:'1960:2020',
		   changeMonth: true,
           changeYear: true,
           showButtonPanel: true,
	   ...
	   jQuery("#"+id+"_"+item,"#collect_batch_add_tb").datepicker({
		   yearRange:'1960:2020',
		   changeMonth: true,
           changeYear: true,
           showButtonPanel: true,
	   ...
	   jQuery("#"+id+"_"+item,"#collect_import_excel_tb").datepicker({
		   yearRange:'1960:2020',
		   changeMonth: true,
           changeYear: true,
           showButtonPanel: true,
