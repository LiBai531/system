        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="">
                <ul class="nav navbar-nav">
                    ...
                    <li style="width:150px;"><a id="experimentInfoManager">实验基础信息管理</a></li>
                    <li><a id="newsManager">新闻管理</a></li>
                    <li><a id="userManager">用户管理</a></li>
                </ul>
            </div>
            <div>
...
$(document).ready(function(){
	var state = "${ sessionScope.userSession.state}";
	
	
	$('#experimentInfoManager').click(function(){
		$.ajax({
            type: "POST",
            url: "/Physics/admin/getExperimentInfo",
            data: {},
            dataType: "json",
	...
	$('#newsManager').click(function(){
		$.ajax({
            type: "POST",
            url: "/Physics/news/getNewsMananger",
            data: {},
            dataType: "json",
            complete: function(result){	
            	console.log(result);
	...
	$('#experimentInfo').click(function(){
		$.ajax({
            type: "POST",
            url: "/Physics/user/getExperimentInfoforAll",
            data: {},
            dataType: "json",
            complete: function(result){	
            	console.log(result);
	...
	$('#userManager').click(function(){
		$.ajax({
            type: "POST",
            url: "/Physics/rbac/getUserManager",
            data: {},
            dataType: "json",
            complete: function(result){	
            	console.log(result);
